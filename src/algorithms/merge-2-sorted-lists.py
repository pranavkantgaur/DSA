...
3. Iterative, in-place:
   ...
   * start with list1: check if first iter of list1 is smaller than that of list2, if so, make list1's first node as head of result list: resultHead = list[0] 
     and advance list1head (thwereby shrinking list1 and expanding resultList)
